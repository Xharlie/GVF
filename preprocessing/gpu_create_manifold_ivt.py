...
if __name__ == "__main__":
    ...
    create_ivt_obj(1, "/ssd1/datasets/ShapeNet/ShapeNetCore.v1/02958343", "./test/2/", "./test/2/",
                   "/hdd_extra1/datasets/ShapeNet/march_cube_objs_v1/02958343", "1a7125aefa9af6b6597505fd7d99b613", 0.01, True, 32768 * 3, 8192, "02958343", 1, unigrid, ballgrid, 0.3, 0.4, True)
